...
## 🧠 ABOUT ME
안녕하세요. AX Engineer 이기쁨입니다.<br>

회계·재무 실무 경험을 기반으로 데이터 분석 역량을 쌓았고<br>
현재는 AI와 소프트웨어를 활용해 업무 자동화 솔루션을 기획·개발하고 있습니다.<br>
...
| 2015.06 - 2015.08 | Business Support Intern    | KTC Co., Ltd.                                  |

### Analyst & Marketing Solutions
- 마케팅 업무 자동화 솔루션 기획 및 개발 | 반복적인 수작업 리포트를 시스템화하여 운영 효율 개선
- 데이터 수집·정제 파이프라인 구축 (Python, SQL)
- KPI 자동 산출 로직 설계 및 리포트 시스템 운영
- 마케팅 데이터 활용 환경 구축
### Accounting & Cash Flow
- 자금 관리 및 회계 업무 수행 | 정기 재무 리포트 작성 및 데이터 기반 운영 지원
- 전사 페이퍼리스 프로세스 도입
- 결산 프로세스 개선 및 표준화
- 업무 매뉴얼 구축 및 운영 효율화
...
- **AI Automation** : AI 도구를 활용한 업무 자동화 솔루션 기획 및 개발
- **Business Problem Solving** : 현업 요구사항 분석 및 프로세스 개선
- **Data Engineering** : 데이터 수집·적재·분석 환경 구축
- **Product Development** : MVP 기획부터 개발·배포·운영까지 수행
- **AI Agent Utilization** : Claude Code, Cursor 기반 개발 생산성 향상
...
<a href="https://github.com/rena-data">
  <picture>
    <source media="(prefers-color-scheme: dark)"
      srcset="https://github-readme-activity-graph.vercel.app/graph?username=rena-data&bg_color=0d1117&color=c9d1d9&line=58a6ff&point=58a6ff&area=true&hide_border=False&days=14&height=400">
    <source media="(prefers-color-scheme: light)"
      srcset="https://github-readme-activity-graph.vercel.app/graph?username=rena-data&bg_color=ffffff&color=708090&theme=github&days=14&height=400">
    <img src="https://github-readme-activity-graph.vercel.app/graph?username=rena-data&theme=github&days=14&height=400"
         width="800" alt="rena-data's github activity graph">
  </picture>
</a>
...
<div align="left">
  ...
  <a href="https://www.linkedin.com/in/rena-data/"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=LinkedIn&logoColor=white"></a>
  <a href="https://ldsjoy.tistory.com/"><img src="https://img.shields.io/badge/Blog-2EA44F?style=for-the-badge&logo=githubpages&logoColor=white"></a>
</div>
